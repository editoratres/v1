insert into menu(nome,descricao, icone,  id, nomepai) values ('Editora3','Editora Três','entypo-book-open',0,null);

insert into menu(nome,descricao, icone,  id, nomepai) values ('cadastro','Cadastro','entypo-list-add',1,0);
...
insert into menu(nome,descricao, icone,  id, nomepai) values ('relatorios','Relatórios','entypo-doc-text-inv',9,0);
...
insert into menu(nome,descricao, icone,  id, nomepai) values ('tabela','Tabelas','entypo-database',15,0);
...
insert into menu(nome,descricao, icone,  id, nomepai) values ('configuracao','Configuração','entypo-tools',21,0);
