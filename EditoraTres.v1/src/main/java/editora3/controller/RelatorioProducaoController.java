...
@Named("relatorioProducaoController")
@RequestScoped
public class RelatorioProducaoController implements Serializable {
	...
	private void iniciar() {
		try {
			...
			jasperRelatorioProduzir.iniciar("producao.jasper");
	...
	public ParametrosRelContratos getItem() {
		ParametrosRelContratos item = (ParametrosRelContratos) getFlashapp().getValoresPorID("relatorioProducaoForm")
				.get("item");
		if (item == null) {
	...
	public void setItens(ParametrosRelContratos item) {
		// TODO Auto-generated method stub
		getFlashapp().getValoresPorID("relatorioProducaoForm").put("item", item);
